...
import { ArrowLeft, Navigation, CheckCircle, AlertTriangle, Users, DollarSign } from 'lucide-react';
import Header from '../../components/Header';
import BottomNav from '../../components/BottomNav';

const LongDistanceTransferPage = () => {
      ...
      <div className="pb-24 md:pb-8">
        ...
        <div className="bg-white px-4 md:px-6 lg:px-8 py-3 flex items-center shadow-sm">
          <div className="max-w-7xl mx-auto w-full">
            <button onClick={() => navigate(-1)} className="flex items-center text-gray-700 hover:text-green-600 transition-colors">
              <ArrowLeft className="w-5 h-5 mr-2" />
              <span className="font-medium text-sm md:text-base">Long Distance Transfer</span>
            </button>
          </div>
        </div>

        {/* Hero Section */}
        <div className="bg-gradient-to-br from-green-50 to-green-100 py-8 md:py-12 lg:py-16 px-4 md:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="max-w-md md:max-w-2xl lg:max-w-4xl mx-auto text-center">
              <div className="w-24 h-24 md:w-32 md:h-32 lg:w-40 lg:h-40 bg-green-200 rounded-3xl mx-auto flex items-center justify-center mb-4 md:mb-6">
                <Navigation className="w-12 h-12 md:w-16 md:h-16 lg:w-20 lg:h-20 text-green-600" />
              </div>
              <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-2000 mb-2 md:mb-3">Long Distance Transfer</h1>
              <p className="text-sm md:text-base lg:text-lg text-gray-600 mb-4 md:mb-6">For inter-city patient transport</p>
              <div className="inline-block bg-green-600 text-white px-4 md:px-6 py-2 md:py-2.5 rounded-full text-xs md:text-sm font-medium">
                Response Time: Scheduled Service
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 mt-6 md:mt-8">
          <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-2000 mb-4 md:mb-6">Service Details</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            <div className="bg-white rounded-xl shadow-sm p-4 flex items-start">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-green-100 rounded-lg flex items-center justify-center mr-3 flex-shrink-0">
                <Navigation className="w-5 h-5 md:w-6 md:h-6 text-green-600" />
              </div>
              <div>
                <p className="text-xs md:text-sm text-gray-600 mb-1">Service Type</p>
                <p className="text-sm md:text-base font-semibold text-gray-2000">Long Distance Transfer</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 flex items-start">
              ...
              <div>
                ...
                <p className="text-sm md:text-base font-semibold text-gray-2000">City-wide Service</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 flex items-start">
              ...
              <div>
                ...
                <p className="text-sm md:text-base font-semibold text-gray-2000">Paramedic Team</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 flex items-start">
              ...
              <div>
                ...
                <p className="text-sm md:text-base font-semibold text-gray-2000">24/7 Service</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* What's Included */}
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 mt-6 md:mt-8">
          <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-2000 mb-4 md:mb-6">What's Included</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
            <div className="bg-white rounded-xl shadow-sm p-4 flex items-start">
              <CheckCircle className="w-5 h-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="text-sm md:text-base font-semibold text-gray-2000 mb-1">Professional Medical Team</h3>
                <p className="text-xs md:text-sm text-gray-600">Experienced staff for long distance care</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 flex items-start">
              <CheckCircle className="w-5 h-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="text-sm md:text-base font-semibold text-gray-2000 mb-1">Comprehensive Medical Equipment</h3>
                <p className="text-xs md:text-sm text-gray-600">Complete medical kit for journey</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 flex items-start">
              <CheckCircle className="w-5 h-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="text-sm md:text-base font-semibold text-gray-2000 mb-1">Oxygen Support</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 flex items-start">
              <CheckCircle className="w-5 h-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="text-sm md:text-base font-semibold text-gray-2000 mb-1">GPS Tracking</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 flex items-start">
              <CheckCircle className="w-5 h-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="text-sm md:text-base font-semibold text-gray-2000 mb-1">Patient Monitoring</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 flex items-start">
              <CheckCircle className="w-5 h-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="text-sm md:text-base font-semibold text-gray-2000 mb-1">Clean & Sanitized</h3>
        ...
        {/* Pricing */}
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 mt-6 md:mt-8">
          <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-2000 mb-4 md:mb-6">Pricing</h2>
          
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-sm p-6 md:p-8">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-green-600">₹4000</h3>
                ...
                <div className="w-12 h-12 md:w-14 md:h-14 bg-green-100 rounded-full flex items-center justify-center">
                  <DollarSign className="w-6 h-6 md:w-7 md:h-7 text-green-600" />
                </div>
              </div>
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-center justify-between py-2 md:py-3 border-b border-gray-100">
                  ...
                  <span className="text-sm md:text-base font-semibold text-gray-2000">₹20/km</span>
                </div>
                <div className="flex items-center justify-between py-2 md:py-3 border-b border-gray-100">
                  <span className="text-sm md:text-base text-gray-600">Emergency Fee</span>
                  <span className="text-sm md:text-base font-semibold text-gray-2000">₹400</span>
                </div>
                <div className="flex items-center justify-between py-2 md:py-3 border-b border-gray-100">
                  <span className="text-sm md:text-base text-gray-600">Night Charges (10 PM - 6 AM)</span>
                  <span className="text-sm md:text-base font-semibold text-gray-2000">₹250</span>
                </div>
              </div>

              <div className="mt-6 p-3 md:p-4 bg-green-50 rounded-xl">
                <p className="text-xs md:text-sm text-green-2000">
          ...
          <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-6 md:p-8 text-white">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm md:text-base text-green-50 mb-3 md:mb-4">For immediate ambulance service, call our 24/7 helpline</p>
                <a href="tel:102" className="inline-block bg-white text-green-600 px-6 md:px-8 py-2.5 md:py-3 rounded-full font-bold text-base md:text-lg hover:bg-green-50 transition-colors">
                  Call 102
                </a>
              </div>
            </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 z-50 overflow-y-auto">
            <div className="min-h-screen px-4 py-8 flex items-start justify-center">
              <div className="bg-white rounded-2xl max-w-2xl w-full">
                <div className="sticky top-0 bg-green-600 text-white p-6 md:p-8 rounded-t-2xl flex items-center justify-between z-10">
              ...
              <form onSubmit={handleSubmit} className="p-4 md:p-6 lg:p-8 space-y-5 md:space-y-6 pb-8">
                {/* Patient Details */}
                <div>
                  <h3 className="text-base md:text-lg font-semibold text-gray-2000 mb-3 md:mb-4">Patient Details</h3>
                  <div className="space-y-3 md:space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 md:px-4 py-2.5 md:py-3 text-sm md:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                        required
                      />
                    </div>
                ...
                {/* Location Details */}
                <div>
                  <h3 className="text-base md:text-lg font-semibold text-gray-2000 mb-3 md:mb-4">Location Details</h3>
                  <div className="space-y-3 md:space-y-4">
                    <div>
                ...
                {/* Emergency Details */}
                <div>
                  <h3 className="text-base md:text-lg font-semibold text-gray-2000 mb-3 md:mb-4">Emergency Details</h3>
                  <div className="space-y-3 md:space-y-4">
                    <div>
                ...
                {/* Payment Method */}
                <div>
                  <h3 className="text-base md:text-lg font-semibold text-gray-2000 mb-3 md:mb-4">Payment Method</h3>
                    ...
                    {['cash', 'card', 'upi', 'insurance'].map((method) => (
                      ...
                      >
                        <input
                          ...
                          required
                        />
                        <span className="text-sm md:text-base font-medium text-gray-2000 capitalize">{method}</span>
                      </label>
                    ))}
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-green-600 text-white py-3 md:py-4 rounded-lg font-semibold text-base md:text-lg hover:bg-green-700 transition-colors"
                >
                  Proceed to Summary
                </button>
              </form>
        ...
        {showSummary && (
          <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="sticky top-0 bg-green-600 text-white p-6 md:p-8 rounded-t-2xl">
              ...
              <div className="p-6 md:p-8 space-y-5 md:space-y-6">
                ...
                <div className="border-b pb-4 md:pb-5">
                  <h3 className="text-base md:text-lg font-semibold text-gray-2000 mb-3">Patient Details</h3>
                ...
                {/* Location Details */}
                <div className="border-b pb-4 md:pb-5">
                  <h3 className="text-base md:text-lg font-semibold text-gray-2000 mb-3">Location Details</h3>
                  <div className="space-y-2 text-sm md:text-base">
                ...
                {/* Emergency Details */}
                <div className="border-b pb-4 md:pb-5">
                  <h3 className="text-base md:text-lg font-semibold text-gray-2000 mb-3">Emergency Details</h3>
                  <div className="space-y-2 text-sm md:text-base">
                ...
                {/* Price Breakdown */}
                <div className="border-b pb-4 md:pb-5">
                  <h3 className="text-base md:text-lg font-semibold text-gray-2000 mb-3">Price Breakdown</h3>
                  <div className="space-y-2 text-sm md:text-base">
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-600">Distance Cost ({formData.distance} km × ₹20)</span>
                    ...
                    <div className="flex justify-between pt-2 md:pt-3 border-t mt-2 md:mt-3">
                      <span className="text-base md:text-lg font-semibold text-gray-2000">Total Amount</span>
                      <span className="text-lg md:text-xl font-bold text-green-600">₹{calculatePricing().total}</span>
                    </div>
                  </div>
                </div>
                ...
                {/* Payment Method */}
                <div>
                  <h3 className="text-base md:text-lg font-semibold text-gray-2000 mb-3">Payment Method</h3>
                ...
                <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-4">
                  <button
                    ...
                    className="flex-1 bg-gray-200 text-gray-2000 py-3 md:py-4 rounded-lg font-semibold text-base md:text-lg hover:bg-gray-300 transition-colors"
                  >
                    Edit Details
                  </button>
                  <button
                    onClick={confirmBooking}
                    className="flex-1 bg-green-600 text-white py-3 md:py-4 rounded-lg font-semibold text-base md:text-lg hover:bg-green-700 transition-colors"
                  >
                    Confirm Booking
                  </button>
                </div>
        ...
        <div className="hidden md:flex max-w-7xl mx-auto px-4 md:px-6 lg:px-8 mt-6 mb-8 justify-center">
          <button
            onClick={() => setShowBookingForm(true)}
            className="max-w-3xl w-full bg-green-600 text-white py-4 md:py-5 rounded-lg font-semibold text-lg md:text-xl hover:bg-green-700 transition-colors shadow-lg"
          >
            Book Service Now
          </button>
        </div>
...
export default LongDistanceTransferPage;
